...
Public Class RoomB
    ...
    Private Sub Room2SetupSerial()
        ...
        Room2SerialPort1.PortName = Room2SerialPortName
	...
	Public Property Room2Pw1Status As Boolean
	Public Property Room2Pw2Status As Boolean
	Public Property Room2Pw3Status As Boolean
    ...
    Private Sub Room2Back_Click(sender As Object, e As EventArgs) Handles Room2Back.Click
        Form1.Show()
        Room2SerialPort1.Close()
        If Not Room2CameraCapture Is Nothing Then
            Room2CameraCapture.Dispose()
        End If
        Me.Hide()
    End Sub
